...
* **`RandomForest.py`** (The "Teacher"):
    ...
    * **What it does:** It loads the training data (`train70_auto.csv`), preprocesses it, trains the Random Forest model, calculates performance metrics (Accuracy, F1-Score, Confusion Matrix), and saves the trained model artifacts for production.
